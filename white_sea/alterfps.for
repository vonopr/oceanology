...
c defines which points are flowing into the domain and ennumerates them with fnum *********************
...
c--------------------------------------------------
      ...
      im=133            ! maximum number for X_i
      jm=110            ! maximum number for Y_j
      km=24             ! maximum number for Z_k
      kmm=24            !    ?????????
      n2=10             !    ?????????
...
79     continue
      ...
      if(ns.eq.33725) print *, 'ns = 33725'     ! finish POLY  - 33704, finish meteo (now) - 33980
